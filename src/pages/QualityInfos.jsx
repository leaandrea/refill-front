        ...
        <div className="quality-container">
          <section className="quality-intro">
            ...
            <p>
              ...
              plastic waste and requires no transportation to get to the
              consumer. Its quality is also on par with, if not better, bottled
              water. On this page, you'll find all the information you need on
              the water you can consume using Refill.
            </p>
            <img
          ...
          <section>
            ...
            <p>
              ...
              fountains in 2010. The water quality of these fountains is the
              same as still water fountains, with one extra step added to make
              the water sparkling.
            </p>
            <p>
          ...
          <section>
            ...
            <p>
              ...
              ways to filter water. The water undergoes two filters to get rid
              of particules and chlorine. It then goes through a third filter
              for reverse osmosis. This last ultrafine filter gets rid of 99% of
              impurities (pesticides, nitrates, bacteria, lead, mercury,
              hormones...) but it 'destructures' the water by changing its
              electromagnetic angle. The water has to be revitalized via
              injection of high frequency waves using silver electrodes. After
              this dynamization process, the water quality is similar to moutain
              water.
            </p>
          </section>
        </div>
