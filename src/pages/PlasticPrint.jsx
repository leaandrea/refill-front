          ...
          <div className="firstContainer">
            ...
            <div className="featureContainer">
              <h3 className="mainText">
                ...
                French people are ones of the biggest consumers of plastic bottles in the world.
           In Paris, less than one in three plastic bottle is collected and recycled! The rest is either polluting the ground or the oceans.
            ...
            <div className="plasticPrintInput">
              <label className="questionLabel" htmlFor="inputBottles">How many plastic bottles do you buy per week ? We'll tell you about your "plastic bottle footprint".</label>
              <input
          ...
          <div className="secondContainer">
            ...
            {this.state.inputValue < 3 && this.state.inputValue >= 1 ? (
              ...
              <div>
                ...
                <div className="imagesContainer">
                  ...
                  <div className="promptsContainers6"> <img className="responseImg6" src="./images/gaz.png" alt="drop6" /><h4>{this.state.gazValue * this.state.inputValue} liters of gaz spent</h4></div>
                </div>
                <h4 className="responseText"> It's good! Your plastic bottles consumption is lower than the French average. But we know you can do even better! Do you know all <Link className="linksPlasticFeature" to="/main-map"> Paris's fabulous spots to refill your water bottle?</Link> They're great, and free. Try them! </h4>
            ...
            {this.state.inputValue === "3" ? (
              <div>
                ...
                <h4 className="responseText">Your plastic bottles consumption is equivalent to the French average. And it's not really great. But we know you can do better! Do you know all <Link className="linksPlasticFeature" to="/main-map">Paris's fabulous spots to refill your water bottle?</Link> Try them!</h4>
              </div>
